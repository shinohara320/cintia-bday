  ...
  return (
    <div>
        <div className="m-10 mx-auto p-16 max-md:p-2 lg:p-48 bg-gray-200">   
            <div className="relative rounded-lg mx-52 block md:flex items-center bg-gray-100 shadow-xl max-md:m-0" style={{ minHeight: '19rem'}}>
            <div className="relative w-1/2 max-md:w-80 max-md:mx-auto h-full overflow-hidden rounded-t-lg md:rounded-t-none md:rounded-l-lg max-md:my-10" style={{ minHeight: '19rem'}}>
                ...
                <div className="absolute inset-0 w-full h-full flex items-center justify-center fill-current text-white">
                    <h1 className="text-5xl poppins font-medium max-md:text-lg">A small message</h1>
                ...
                <div className="p-12 md:pr-24 md:pl-16 md:py-0 md:m-0">
                    <p className="text-gray-600 poppins">
                        <span className="text-gray-900">
                         ...
                         I hope all goes smoothly, wether it study or your life, once again Happy Birthday, and thanks for accompaning me last week, this might be our last conversation, 
                        and i probably already asking your answear, so either you accept or reject it, its fine.
                        i dont have any expectation to begin with, but gradually you stuck on my mind. and even if you accept it 
                        i dont think im where i want right now. This is my last message, maybe if we meet again in another chance, 
                        i would glady talking to you. 
                    </p>
                </div>
